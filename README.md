...
Именование веток
----------------
* **feature-НОМЕР_ЗАДАЧИ-короткое\_описание\_новой\_функции** - для нового функционала
* **fix-НОМЕР_ЗАДАЧИ_ЕСЛИ_ЕСТЬ-короткое\_описание\_исправляемой\_ошибки** - для багфикса
